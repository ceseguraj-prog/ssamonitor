...
$datos = $_SESSION['terceros_archivos'][$token] ?? null;

if (!is_array($datos) || !is_file($datos['ruta'])) {
    http_response_code(404);
    header('Content-Type: text/html; charset=utf-8');
    echo '<!doctype html><meta charset="utf-8"><title>No disponible</title>'
        . '<p style="font-family:system-ui;padding:2rem">El paquete ya no está disponible. '
        . 'Vuelve a generar el reporte.</p>';
    exit;
}
...
// Sin buffer intermedio: el paquete de una quincena completa pesa varios MB.
